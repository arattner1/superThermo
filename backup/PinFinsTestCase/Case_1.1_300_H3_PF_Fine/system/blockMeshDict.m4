...
define(NX, 50)                  
define(NY, 70)                  
define(NZ, 274)               //Number of cells across unheated section (radial direction)
define(ExpRat, 68.52)         //Walls expansion ratio 
define(ExpRatP, 1)           //Expansion ratio around Pins
