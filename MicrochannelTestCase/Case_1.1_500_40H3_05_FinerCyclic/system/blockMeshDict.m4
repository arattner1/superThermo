...
define(LMap,  4E-3)	      //Development length
define(L2,  5E-3)	      //Total Domain length
define(NXY, 98)                  //Number of cells across (radial direction)
define(NZ1, 98)               //Number of cells across unheated section (radial direction)
define(NZ2, 98)               //Number of cells across heated section (radial direction)
define(ExpRat, 103.9)           //Expansion ratio in x-direction
