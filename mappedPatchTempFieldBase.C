...
#include "mappedPatchTempFieldBase.H"
...
template<class Type>
mappedPatchTempFieldBase<Type>::mappedPatchTempFieldBase
(
...
mappedPatchTempFieldBase<Type>::mappedPatchTempFieldBase
(
    const mappedPatchTempFieldBase<Type>& mapper
)
:
...
(
    const mappedPatchBase& mapper,
    const fvPatchField<Type>& patchField,
    const mappedPatchTempFieldBase<Type>& base
)
:
    mapper_(mapper),
    patchField_(patchField),
...
mappedPatchTempFieldBase<Type>::sampleField() const
{
...
template<class Type>
tmp<Field<Type>> mappedPatchTempFieldBase<Type>::mappedField() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> fieldType;
...
template<class Type>
void mappedPatchTempFieldBase<Type>::write(Ostream& os) const
{
