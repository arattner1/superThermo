...
//Added by MN
const Foam::volScalarField& Foam::psiThermo::drhodh() const
{
    notImplemented("psiThermo::drhodh()");
    return const_cast<volScalarField&>(volScalarField::null());
}

const Foam::volScalarField& Foam::psiThermo::drhode() const
{
    notImplemented("psiThermo::drhode()");
    return const_cast<volScalarField&>(volScalarField::null());
}
